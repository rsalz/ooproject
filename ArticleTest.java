...
public class ArticleTest {
	...
	public void setUp() throws Exception {
		article1 = new Article("Marrow fat and bone: new perspectives", new String[] {"Fazelli, Patrick", "Horowitz, Mark", "MacDougald, Ornella"}, 2013, cites, citedby, "Journal of Clinical Endocrinology and Metabolism", 3);
	}
